  ...
  async sendNotification(notificationId) {
    try {
      ...
      const notification = await Notification.findById(notificationId).populate(
        "recipient",
        "name email contactNumber preferences"
      );
    ...
    const templates = {
        ...
        html: `
          ...
          ${
            notification.actionUrl
              ? `<p><a href="${baseUrl}${notification.actionUrl}" style="background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Details</a></p>`
              : ""
          }
      ...
      PAYMENT_REMINDER: {
        ...
        html: `
          ...
          ${
            notification.actionUrl
              ? `<p><a href="${baseUrl}${notification.actionUrl}" style="background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Process Payment</a></p>`
              : ""
          }
        ...
        text: `Payment Reminder\n\nDear ${notification.recipient.name},\n\n${
          ...
          notification.actionUrl
            ? `Process payment: ${baseUrl}${notification.actionUrl}\n\n`
            : ""
        }Best regards,\nHTD Finance Team`,
      },
      EVALUATION_DUE: {
        ...
        html: `
          ...
          ${
            notification.actionUrl
              ? `<p><a href="${baseUrl}${notification.actionUrl}" style="background: #ffc107; color: black; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Complete Evaluation</a></p>`
              : ""
          }
          <p>Best regards,<br>HTD Training Team</p>
        `,
        text: `Evaluation Due\n\nDear ${notification.recipient.name},\n\n${
          ...
          notification.actionUrl
            ? `Complete evaluation: ${baseUrl}${notification.actionUrl}\n\n`
            : ""
        }Best regards,\nHTD Training Team`,
      },
    };
