...
export const getMonthlySummary = async (req, res) => {
  try {
    ...
    const summary = await Payment.getMonthlyPaymentSummary(candidateId, currentYear);
...
export const getMonthlyPaymentSummary = async (req, res) => {
  try {
    ...
    const summary = await Payment.getMonthlyPaymentSummary(candidateId, parseInt(year, 10));
