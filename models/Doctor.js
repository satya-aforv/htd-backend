// server/models/Doctor.js - Updated to support multiple files
...
doctorSchema.index({ name: 'text', email: 'text', gstNumber: 'text' });

// Virtual to get total documents count
doctorSchema.virtual('documentsCount').get(function() {
  return this.documents ? this.documents.length : 0;
});

// Virtual to get file download URLs
doctorSchema.virtual('documentUrls').get(function() {
...
doctorSchema.virtual('agreementFileUrl').get(function() {
...
doctorSchema.virtual('agreementFileViewUrl').get(function() {
  if (this.agreementFile && this.agreementFile.filename) {
...
doctorSchema.methods.addDocument = function(fileData) {
  this.documents.push(fileData);
  return this.save();
};

// Method to remove a document
doctorSchema.methods.removeDocument = function(documentId) {
  this.documents.id(documentId).remove();
  return this.save();
};

// Method to update a document
doctorSchema.methods.updateDocument = function(documentId, updateData) {
